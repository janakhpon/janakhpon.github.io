        ...
        return (
            <section className="resume-section p-3 p-lg-5 d-flex align-items-center" id="interests">
                <Head className="w-100">
                    ...
                    <p className="mb-0">When forced indoors, I love reading novels and tech news, writing poems (check my facebook profile ..) next to backyard's window and watching animes (One Piece, Naruto ...).</p>
                    <p className="mb-0">I also have a habbit of continuous learning of modern technology which could mesmerize me (Currently Golang, Rustlang and AI) . </p>
                </Head>
            </section>
        );
    }
