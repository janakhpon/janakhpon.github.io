                ...
                <div className="w-100">
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="resume-content">
                            ...
                            <p>UI/UX design library for future projects are built using SASS/SCSS, LESS, CSS3 and HTML5 and a combination other popular design libraries.</p>
                        </div>
                        <div className="resume-date text-md-right">
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="resume-content">
                            ...
                            <p>Crossed Platform Application are targeting to Linux,Windows and Mac Operating System and are built using ElectronJS, Tkinter and PyQt5. </p>
                        </div>
                        <div className="resume-date text-md-right">
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="resume-content">
                            ...
                            <p>Mobile Applications are usually developed by using ReactNative and a variety of Database including NoSQL and SQL.</p>
                        </div>
                        <div className="resume-date text-md-right">
